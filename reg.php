			...
			$.ajax({
				...
				success:function(reStr){
					if($.trim(reStr) == "Y"){
						...
						$("#msgContainer").html("恭喜您注册成功！正在跳转到首页...");
						setTimeout("window.location.reload();",1500);
					}else{
						$("#msgContainer").css("color","red");
						$("#msgContainer").html("当前会员名已被注册！");
					}
				}
			})
		}
...
<body>
	<p>欢迎加入瑜伽之光！</p>
<form action="" id="register_form" method="post" accept-charset="utf-8">
	<table align="center">
		<tr>
			<td>会员名：</td>
		...
		<tr>
			<td colspan="2" align="center"><input value="注册" class="btn" onclick="validReg();" type="button"></td>
		</tr>
		<tr>
